...
PDB files are first parsed to remove hetero atoms, then converted to "gninatypes" files and finally collected into a "molcache" file for quicker input and model training with libmolgrid. More about "gninatypes" and "molcache" [here](https://github.com/gnina/gnina). 
...
Prepared types, molcache and saved model checkpoints can be downloaded [here](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/rishal_aggarwal_research_iiit_ac_in/EoJSrvuiKPlAluOJLjTzfpcBT2fVRdq8Sr4BMmil0_tvHw?e=Kj7reS). SC6K can be downloaded from [here](https://www.dropbox.com/s/cd9h2qtaphtvx6w/data.zip?dl=1).
